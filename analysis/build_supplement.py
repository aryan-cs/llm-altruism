...
HOSTED_REPRODUCIBILITY_ALLOWLIST = frozenset(
    {
        ...
        Path("experiments") / "misc" / "inference_hub_part1_operational_repair.py",
        ...
        Path("experiments") / "misc" / "inference_hub_part2_sensitivity_operational_repair.py",
        ...
        Path("tests") / "test_inference_hub_part1_operational_repair.py",
        ...
        Path("tests") / "test_inference_hub_part2_sensitivity_operational_repair.py",
