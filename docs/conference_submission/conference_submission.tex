...
The release packages task contracts, schemas, validation, provenance seals, Croissant metadata, tables, figures, and reproduction commands; it makes both supported results and disqualifying evidence traceable.
\end{abstract}
...
\setlength{\parsep}{0pt}
    ...
    \item Croissant metadata: \path{data/analysis/croissant_metadata.json}. Croissant 1.1/RAI 1.0 validation and real-row loading pass for all seven released record sets; invalid Part~0 and dependent cross-part tables are excluded. A stable anonymous dataset URL must be added with the generator's \texttt{--dataset-url} option before public hosting.
