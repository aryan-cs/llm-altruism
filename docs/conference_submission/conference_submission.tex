...
The gap addressed here is the combination of harmful-request refusal, one-shot social-dilemma cooperation, repeated commons restraint, and traceable release artifacts in one validated benchmark. Table~\ref{tab:positioning} summarizes this positioning. The pilot cohort uses locally runnable variants across GPT-OSS \citep{openai2025gptoss}, Llama~2 \citep{touvron2023llama2}, Qwen~2.5 \citep{yang2024qwen25}, and Ollama-hosted Qwen~3.5 tags \citep{ollama2026qwen35}.
