...
\makeatletter
\def\input@path{{../conference_submission/}}
\makeatother

% Public upload build of the standalone research proposal.
...
\newcommand{\ProposalTitle}{Research Proposal: Measuring Altruism, Alignment, and Social Welfare in Large Language Model Agents}
\newcommand{\ProposalSubject}{Research proposal for evaluating alignment, safety refusal, cooperation, commons restraint, reputation, and social welfare behavior in LLM agents.}
\newcommand{\ProposalKeywords}{large language models, LLM altruism, alignment, LLM evaluation, safety refusal, harmful compliance, cooperation, commons restraint, social welfare, agent simulation, research proposal}
\newcommand{\ProposalRepositoryUrl}{https://github.com/aryan-cs/llm-altruism}
...
\AtBeginDvi{\special{pdf:docinfo <<
  /Title (Research Proposal: Measuring Altruism, Alignment, and Social Welfare in Large Language Model Agents)
  /Author (Aryan Gupta)
  /Subject (Research proposal for evaluating alignment, safety refusal, cooperation, commons restraint, reputation, and social welfare behavior in LLM agents.)
  /Keywords (large language models, LLM altruism, alignment, LLM evaluation, safety refusal, harmful compliance, cooperation, commons restraint, social welfare, agent simulation, research proposal)
>>}}
...
\begin{center}
\fbox{\parbox{0.94\linewidth}{\small\textbf{Historical, superseded proposal (May 2026).}
This document preserves the original planning narrative and is not the current
execution protocol. The current protocol is \path{docs/CONFIRMATORY_PROTOCOL.md}.
Legacy Part~0 and refusal-dependent cross-part claims are invalid; Part~1 is now
a focal single-response task; no composite altruism or readiness score is
supported.}}
\end{center}
